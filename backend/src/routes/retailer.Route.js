...
import { RetailerRegister,RetailerLogin ,RetailerLogout,RetailerConversation} from "../controllers/retailer.controller.js"
...
retailrouter.route('/conversation').post(VerifyJwtRetailer,RetailerConversation)
